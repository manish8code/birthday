...
const Wish = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="centered h-dvh flex flex-col items-center justify-center leading-[0.9] px-5 "
    >
      
      <div className=" m-3.5">
        <h2
          ref={textRef}
          className="first-text text-center font-antonio font-bold text-[#832c40] text-shadow-red-900/55 md:text-shadow-lg text-shadow-md
